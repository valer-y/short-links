...
defined('SHORTLINKS_DOUBLE_CLICK_TIME') || define('SHORTLINKS_DOUBLE_CLICK_TIME', 2 * MINUTE_IN_SECONDS);
defined('SHORTLINKS_SESSION_LIVE_TIME') || define('SHORTLINKS_SESSION_LIVE_TIME', 12 * HOUR_IN_SECONDS);
